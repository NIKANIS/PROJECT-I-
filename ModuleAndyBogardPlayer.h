#ifndef __MODULEANDYBOGARDPLAYER_H__
#define __MODULEANDYBOGARDPLAYER_H__
...
class ModuleAndyBogardPlayer : public Module
{
public:
	ModuleAndyBogardPlayer();
	~ModuleAndyBogardPlayer();
